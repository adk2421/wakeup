...
thumbnail: /page/dev/menu/nodejs/images/thumbnail-express.png
link-type: link
---
...
![start-express-1]({{ site.baseurl }}/page/dev/menu/nodejs/images/start-express-1.png)
<br/>
...
![start-express-2]({{ site.baseurl }}/page/dev/menu/nodejs/images/start-express-2.png)
<br/>
...
npm i express
```
![start-express-3]({{ site.baseurl }}/page/dev/menu/nodejs/images/start-express-3.png)
<br/>

4. <span class="marker">Express 설치가 완료되면 `node_modules`와 `package-lock.json`이 생성된다.</span>
![start-express-4]({{ site.baseurl }}/page/dev/menu/nodejs/images/start-express-4.png)
...
![start-express-5]({{ site.baseurl }}/page/dev/menu/nodejs/images/start-express-5.png)
<br/>
...
2. <span class="marker">프로젝트 폴더 루트에 `index.js` 파일을 생성한 후, 아래 내용을 붙여넣는다.</span>
   ...
   ```
![start-express-6]({{ site.baseurl }}/page/dev/menu/nodejs/images/start-express-6.png)
<br/>
...
node index.js
```
![start-express-7]({{ site.baseurl }}/page/dev/menu/nodejs/images/start-express-7.png)
<br/>

4. <span class="marker">`index.js`파일의 'Hello World!' 문구를 수정한 다음, 서버를 다시 시작해본다. ( 터미널에서 `Ctrl` + `c`를 누르면 서버를 내릴 수 있다 )</span>
![start-express-8]({{ site.baseurl }}/page/dev/menu/nodejs/images/start-express-8.png)
<br/>

5. <span class="marker">수정 완료</span>
![start-express-9]({{ site.baseurl }}/page/dev/menu/nodejs/images/start-express-9.png)
