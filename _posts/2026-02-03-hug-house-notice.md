...
<div class="flow">
	<div class="flow-box">
		...
		<div class="flow-content">
			<p class="primary-color bold">신청인</p>
			<p>주택별 정보확인</p>
		</div>
	</div>
	...
	<div class="flow-box">
		...
		<div class="flow-content">
			<p class="primary-color bold">신청인 → 공사</p>
			<p>본인인증 후 입주신청</p>
		</div>
	</div>
	<div class="flow-separator">&gt;</div>
	<div class="flow-box">
		...
		<div class="flow-content">
			<p class="primary-color bold">공사</p>
			<p>무작위 추첨</p>
		</div>
	</div>
	<div class="flow-separator">&gt;</div>
	<div class="flow-box">
		...
		<div class="flow-content">
			<p class="primary-color bold">공사 → 신청인</p>
			<p>서류제출 안내</p>
		</div>
	</div>
	<div class="flow-separator">&gt;</div>
	<div class="flow-box">
		...
		<div class="flow-content">
			<p class="primary-color bold">서류제출 대상자 → 공사</p>
		</div>
	</div>
	<div class="flow-separator">&gt;</div>
	<div class="flow-box">
...
[hug-jeonse-notice-pdf]: https://www.khug.or.kr/hug/homepage_file_upload/jeonse_notice_260130.pdf
[hug-jeonse]: https://www.khug.or.kr/jeonse/web/s07/s070102.jsp